...
class eooten_Customize_Frontent {
	...
	public static function customizer_css() {
		...
		echo apply_filters('eooten/cached_css', $cached_css);
		echo '/* WP Customizer end */';

		wp_add_inline_style('eooten-style', ob_get_clean());
	}
...
?>
		<meta name="theme-color" content="<?php echo esc_html(get_theme_mod('browser_header_color', '#312c48')); ?>">
		<meta name="msapplication-navbutton-color" content="<?php echo esc_html(get_theme_mod('browser_header_color', '#312c48')); ?>">
<?php
	}
}
