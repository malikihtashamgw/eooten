 ...
 */
?>
<article id="post-<?php the_ID() ?>" <?php post_class('bdt-article post-format-video bdt-text-' . get_theme_mod('eooten_blog_align', 'center')) ?> data-permalink="<?php the_permalink() ?>" typeof="Article">
