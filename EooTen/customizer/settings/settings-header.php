	...
	protected function register_tab_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'description' => sprintf(__('Go to <a href="%s">Site Identity</a> to manage your site\'s title and tagline', 'eooten'), wp_nonce_url('customize.php?autofocus[section]=title_tagline')),
				'condition' => [
					'hello_header_logo_display' => 'yes',
					'hello_header_logo_type' => 'title',
				],
		...
		if (1 === count($menus)) {
			...
			$this->add_control(
				...
				[
					'label' => __('Menu Layout', 'eooten'),
					'type' => Controls_Manager::SELECT,
					'default' => 'horizontal',
					'options' => [
						'horizontal' => __('Horizontal', 'eooten'),
						'dropdown' => __('Dropdown', 'eooten'),
					],
					'frontend_available' => true,
				]
			);
			...
			$this->add_control(
				...
				[
					'label' => __('Breakpoint', 'eooten'),
					'type' => Controls_Manager::SELECT,
					'default' => 'tablet',
					'options' => [
						/* translators: %d: Breakpoint number. */
						'mobile' => sprintf(__('Mobile (< %dpx)', 'eooten'), $breakpoints['md']),
						/* translators: %d: Breakpoint number. */
						'tablet' => sprintf(__('Tablet (< %dpx)', 'eooten'), $breakpoints['lg']),
						'none' => __('None', 'eooten'),
					],
					'selector' => '.site-header',
					'condition' => [
	...
	public function get_additional_tab_content() {
		if (!defined('ELEMENTOR_PRO_VERSION')) {
			return sprintf(
				...
				',
				__('Create a custom header with multiple options', 'eooten'),
				__('Upgrade to Elementor Pro and enjoy free design and many more features', 'eooten'),
				__('Go Pro', 'eooten'),
